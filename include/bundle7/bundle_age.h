 ...
 * This function can be used to parse the payload of an bundle age
 * extension block.
 *
 * @param bundle_age uint_64_t bundle age
...
/**
 * Maximal length of a CBOR-encoded bundle age
...
/**
 * Generates the CBOR-encoded version of the given bundle age and writes it
 ...
 */
size_t bundle_age_serialize(const uint64_t bundle_age, uint8_t *buffer,
	size_t length);
